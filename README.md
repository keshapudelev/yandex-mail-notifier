...
- [x] Опциональная обработка ссылок "mailto:" (реализован штатными обработчиками браузера)
- [x] Кнопка открытия почты неосновного аккаунта (сейчас, как и в старом расширении, нужно сначала перейти на нужный аккаунт и только после этого можно его открыть)
